#!/usr/bin/env python3
"""Export human-readable intervention-test reports from a saved trace."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--trace-input", required=True, type=str, help="intervention .npz trace path")
...
def _load_adjusted_clips(args: argparse.Namespace, demo_keys: List[str]):
    trace_bundle = load_intervention_trace_file(resolve_repo_relative_path(args.trace_input, repo_root=REPO_ROOT))
