...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.EEF_POS_4DOF]:
        raise ValueError(f"Cannot load `{dataset_name}`; only EEF_POS, EEF_R6 & EEF_POS_4DOF actions supported!")
